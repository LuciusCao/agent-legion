...
def test_counts_table_and_trigger_exist() -> None:
    ...
    with read_connection(TEST_DATABASE_URL) as conn:
        ...
        trigger = conn.execute(
            ...
            " and trigger_name='jobs_run_status_counts_sync_update'"
...
def test_count_jobs_by_status_in_run_matches_group_by(tmp_path) -> None:
    ...
    # The read uses compact counter sources, never the run's jobs slice: pin
    # base PK access so a future rewrite cannot regress to a jobs group-by.

...
def test_workspace_membership_roundtrip(job_db) -> None:
    user = _make_user(job_db)
    workspace = job_db.create_workspace(default_workflow_key="demo_workflow", name="Auth WS")
...
def test_workspace_membership_validates_refs_and_role(job_db) -> None:
    user = _make_user(job_db)
    workspace = job_db.create_workspace(default_workflow_key="demo_workflow", name="Auth WS 2")

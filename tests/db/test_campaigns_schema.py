...
def _job_db() -> CampaignQueriesMixin:
    # The mixin is enough: its own connection wiring (ConnectionQueriesMixin)
    # carries _path; no facade needed for these direct-layer tests.
    job_db = CampaignQueriesMixin.__new__(CampaignQueriesMixin)

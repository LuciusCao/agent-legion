...
def test_add_video_list_artifacts_and_rerun(tmp_path):
    ...
    artifacts = client.get("/api/videos/g1/artifacts").json()
    assert artifacts["subtitles"][0]["text"] == "你好"

    rerun = client.post("/api/videos/g1/rerun", json={"phase": "transcribe"})

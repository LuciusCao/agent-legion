...
EXPECTED_OPERATIONS = {
    ...
    ("get", "/api/workspaces/{workspace_id}/node-runs"): "WorkspaceRunsResponse",
    ("post", "/api/workspaces/{workspace_id}/runs"): "RunCreateResponse",
    ("get", "/api/workspaces/{workspace_id}/runs"): "RunListResponse",
    ("get", "/api/workspaces/{workspace_id}/runs/{run_id}"): "RunDetailResponse",

...
def test_builtin_sources_and_lock_cover_the_same_nine_skills() -> None:
    assert len(BUILTIN_SKILL_SOURCES.skills) == 9
    assert set(BUILTIN_SKILL_SOURCES.skills) == set(BUILTIN_SKILL_LOCK.skills)

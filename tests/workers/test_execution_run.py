...
The upload-handoff / attempt-reclaim family lives in the sibling
test_execution_run_handoff.py (#779 codex train review R3 split); shared
fakes/builders are in tests/workers/execution_run_testlib.py.
"""

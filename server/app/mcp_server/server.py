...
studio-agent scoped token (STUDIO-AGENT-001). The only exception is
``get_authoring_guide``, which serves the built-in authoring playbook
(``authoring_guide.AUTHORING_GUIDE``) locally without an HTTP call.
"""

"""Schema v86 (#759): execution generation columns.
...
ceiling (the v76/v84 precedent): fresh and pre-v86 databases both run
this apply fn, and the parity test pins the shapes equal. Default 0 keeps
legacy rows consistent: a pre-v86 in-flight lease and its job share epoch
...
def migrate_execution_generation(conn: Any) -> None:
    """Add the execution-generation epoch columns (v86, #759); idempotent."""

...
pin tests under tests/db/). Order note: migrate_runs (v53) must run after
every migration that still reads job_batches (e.g. the v34
external-connections rewrite); the version-sorted registry guarantees it.
"""

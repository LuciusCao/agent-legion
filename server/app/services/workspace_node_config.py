...
Node keys/schemas resolve from the workspace's ACTIVE workflow revision
(schema v50): the retired global catalog template could go stale against the
published revision, so overrides validate against what actually runs.
"""

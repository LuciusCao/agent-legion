...
def _validate_subtitle_review(video_dir: Path) -> None:
...
def _validate_chapter_generate(video_dir: Path) -> None:
...
def _validate_interaction_generate(video_dir: Path) -> None:
...
def _validate_content_review(video_dir: Path) -> None:
...
def validate_phase_outputs(video_dir: Path, phase_key: str) -> None:
    ...
    if phase_key == "subtitle_review":
        _validate_subtitle_review(video_dir)
    elif phase_key == "chapter_generate":
        _validate_chapter_generate(video_dir)
    elif phase_key == "interaction_generate":
        _validate_interaction_generate(video_dir)
    elif phase_key == "content_review":
        _validate_content_review(video_dir)

 ...
 * 没有可回落的顶层 execution 默认（provider/model 皆空）且至少一个 agent
 * 节点自身也没配齐时提醒；全部节点各自配齐即非缺口，不提示（#666）。节点
 * 级缺口同时由节点警告徽标（DagNodeHeader）承载。草稿 YAML 解析失败时画布
 * 回退 published（其顶层块形状不可得，误报比漏报更吵），不提示。 */

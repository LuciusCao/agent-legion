...
export function InteractionOverlay({
  ...
  const moveSummaryOptionByOffset = (activeOptionId: string, offset: number) => {
    setSelectedOptions((current) => {
    ...
    return (
      <div className={styles.practiceToast}>
        ...
        <div className={styles.actionRow}>
          <button className={styles.textButton} type="button" onClick={onContinue}>
            跳过
          </button>
    ...
    return (
      <div className={styles.interactionOverlay}>
        <div className={styles.summaryPanel}>
          <p className={styles.cardTitle}>{node.instruction || "按顺序选择"}</p>
          {node.reference_sentence && <p className={styles.hintText}>{node.reference_sentence}</p>}
    ...
    return (
      <div className={styles.interactionOverlay}>
        <div className={styles.practiceCard}>
          ...
          <div className={styles.optionGrid}>
            {options.map((opt, i) => (
              <button className={styles.optionButton} type="button" key={i} onClick={onContinue}>
                {opt.text}
              </button>
            ))}
          </div>

...
describe("VideoPlayer", () => {
  it("renders empty state when no video URL", () => {
    render(
      <VideoPlayer
        video={{ id: "v1", title: "Test", content_type: "knowledge", status: "queued", source_url: "", external_id: "", knowledge_code: "", question_id: "", source_uuid: "", current_phase: "download", error_message: "" }}

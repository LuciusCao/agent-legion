...
type RegistryDoc = StudioAgentRegistryResponse
...
function StudioAgentsEditor({ initial }: { initial: RegistryDoc }) {
  ...
  // 409 响应携带的最新注册表（与存储同事务产出）——刷新取数源。
  const [conflictBody, setConflictBody] = useState<RegistryDoc | null>(null)

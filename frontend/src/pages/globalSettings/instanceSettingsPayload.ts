// 实例设置表单的值校验与 PUT 载荷构建（从 instanceSettingsForm 拆出以
// 控制体积预算；#509/#554 的容量旋钮字段同表登记。读方向 doc → 表单值
// 在姊妹文件 instanceSettingsFormValues.ts，本文件只管写方向）。

import type { InstanceSettingsUpdate } from '../../api/instanceSettings'
import { fieldDef } from './instanceSettingsFields'
import type { FormValues } from './instanceSettingsFormValues'

export type { FormValues } from './instanceSettingsFormValues'
export { toFormValues } from './instanceSettingsFormValues'

...
export type MaterialListResponse = ApiSchemas['MaterialListResponse']
...
export type MaterialBundleCreateRequest =
  ApiSchemas['MaterialBundleCreateRequest']
export type MaterialBundleResponse = ApiSchemas['MaterialBundleResponse']
export type RunItem =
